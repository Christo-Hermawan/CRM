...
const Experience = () => {
  ...
  return (
    <Box sx={{ padding: '8rem', textAlign: 'center', backgroundColor: '#eaeaea', color: '#333' }}>
      ...
      {showBCA && (
        ...
        >
          ...
          <Typography variant="body1">
            • Developed modules for BCA's internal CMS.<br />
            • Worked on bug fixes and functionality improvements for the currency page.<br />
            • Conducted API testing and web functionality testing to ensure quality and stability.<br />
            • Gained valuable experience in system testing, problem-solving, and communication.
          </Typography>
        </Paper>
      )}
      ...
      {showDjarum && (
        ...
        >
          ...
          <Typography variant="body1">
            • Provided technical support and assistance for internal systems.<br />
            • Troubleshot and resolved hardware and software issues for employees.<br />
            • Gained hands-on experience in IT support and user interaction.
          </Typography>
        </Paper>
      )}
    </Box>
